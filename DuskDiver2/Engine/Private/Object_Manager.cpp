...
HRESULT CObject_Manager::Add_Get_GameObjectToLayer(const _tchar * pPrototypeTag, _uint iLevelIndex, const _tchar * pLayerTag, void * pArg, CGameObject ** Out_pObj)
{
	CGameObject*		pGameObject = Clone_GameObject(pPrototypeTag, pArg);
