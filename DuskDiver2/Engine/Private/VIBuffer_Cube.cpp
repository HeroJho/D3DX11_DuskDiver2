...
#pragma region VERTEXBUFFER
	...
	// Nor
	_vector vPX = XMVectorSet(1.f, 0.f, 0.f, 0.f);
	_vector vMX = XMVectorSet(-1.f, 0.f, 0.f, 0.f);
	_vector vPY = XMVectorSet(0.f, 1.f, 0.f, 0.f);
	_vector vMY = XMVectorSet(0.f, -1.f, 0.f, 0.f);
	_vector vPZ = XMVectorSet(0.f, 0.f, 1.f, 0.f);
	_vector vMZ = XMVectorSet(0.f, 0.f, -1.f, 0.f);

	XMStoreFloat3(&pVertices[0].vNormal, XMVector4Normalize(vMX + vPY + vMZ));
	XMStoreFloat3(&pVertices[1].vNormal, XMVector4Normalize(vPX + vPY + vMZ));

	XMStoreFloat3(&pVertices[2].vNormal, XMVector4Normalize(vPX + vMY + vMZ));
	XMStoreFloat3(&pVertices[3].vNormal, XMVector4Normalize(vMX + vMY + vMZ));

	XMStoreFloat3(&pVertices[4].vNormal, XMVector4Normalize(vMX + vPY + vPZ));
	XMStoreFloat3(&pVertices[5].vNormal, XMVector4Normalize(vPX + vPY + vPZ));

	XMStoreFloat3(&pVertices[6].vNormal, XMVector4Normalize(vPX + vMY + vPZ));
	XMStoreFloat3(&pVertices[7].vNormal, XMVector4Normalize(vMX + vMY + vPZ));
