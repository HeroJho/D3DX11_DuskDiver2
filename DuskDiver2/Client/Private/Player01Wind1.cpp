#include "stdafx.h"
#include "..\Public\Player01Wind1.h"
#include "GameInstance.h"
#include "Time_Manager.h"

CPlayer01Wind1::CPlayer01Wind1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CEffect(pDevice, pContext)
{
}

CPlayer01Wind1::CPlayer01Wind1(const CPlayer01Wind1& rhs)
	: CEffect(rhs)
{
}

HRESULT CPlayer01Wind1::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer01Wind1::Initialize(void * pArg)
{
	m_pInfo = (*(WIND1INFO**)pArg);
...
void CPlayer01Wind1::Tick(_float fTimeDelta)
{
...
void CPlayer01Wind1::LateTick(_float fTimeDelta)
{
...
HRESULT CPlayer01Wind1::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Effect_GroundWind"), TEXT("Player01Wind1"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

CEffect * CPlayer01Wind1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer01Wind1*		pInstance = new CPlayer01Wind1(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CPlayer01Wind1"));
...
CGameObject * CPlayer01Wind1::Clone(void * pArg)
{
	CPlayer01Wind1*		pInstance = new CPlayer01Wind1(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CPlayer01Wind1"));
		Safe_Release(pInstance);
	}
