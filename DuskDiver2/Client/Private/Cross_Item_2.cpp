...
CCross_Item_2::CCross_Item_2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{
}

CCross_Item_2::CCross_Item_2(const CCross_Item_2 & rhs)
	: CUI(rhs)
{
}

HRESULT CCross_Item_2::Initialize_Prototype()
{
...
HRESULT CCross_Item_2::Initialize(void * pArg)
{
...
void CCross_Item_2::Tick(_float fTimeDelta)
{
	...
	if (CK_DOWN(DIK_RIGHT) && !UM->Get_ShopState())
	{
		switch (UM->Get_BattleItemNum(2))
		{
		case 0:
...
void CCross_Item_2::LateTick(_float fTimeDelta)
{
...
HRESULT CCross_Item_2::Render()
{
	...
	_uint i = UM->Get_BattleItemNum(2);
...
HRESULT CCross_Item_2::Ready_Components()
{
...
void CCross_Item_2::Render_Debug()
{
...
CCross_Item_2 * CCross_Item_2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CCross_Item_2*		pInstance = new CCross_Item_2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CCross_Item_2"));
...
CGameObject * CCross_Item_2::Clone(void * pArg)
{
	CCross_Item_2*		pInstance = new CCross_Item_2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CCross_Item_2"));
		Safe_Release(pInstance);
	}
