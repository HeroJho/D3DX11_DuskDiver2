#include "stdafx.h"
#include "..\Public\NumItemEffect.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumItemEffect::CNumItemEffect(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumItemEffect::CNumItemEffect(const CNumItemEffect & rhs)
	: CUI(rhs)
{

}

HRESULT CNumItemEffect::Initialize_Prototype()
{
...
HRESULT CNumItemEffect::Initialize(void * pArg)
{
...
void CNumItemEffect::Tick(_float fTimeDelta)
{
...
void CNumItemEffect::LateTick(_float fTimeDelta)
{
...
void CNumItemEffect::Render_Debug()
{
...
void CNumItemEffect::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumItemEffect::Ready_Components()
{
...
CNumItemEffect * CNumItemEffect::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumItemEffect*		pInstance = new CNumItemEffect(pDevice, pContext);
...
CGameObject * CNumItemEffect::Clone(void * pArg)
{
	CNumItemEffect*		pInstance = new CNumItemEffect(*this);
