...
CNPC_Line06::CNPC_Line06(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line06::CNPC_Line06(const CNPC_Line06 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line06::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line06::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(24.8f, 2.f, 4.9f, 1.f));

	return S_OK;
}

void CNPC_Line06::Tick(_float fTimeDelta)
{
	m_fPlayerPos = PM->Get_PlayerPos();
	m_bOn = m_pTransformCom->Check_LimitDistance(XMLoadFloat4(&m_fPlayerPos), 5.2f);
...
void CNPC_Line06::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line06::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line06 * CNPC_Line06::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line06*		pInstance = new CNPC_Line06(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line06"));
...
CGameObject * CNPC_Line06::Clone(void * pArg)
{
	CNPC_Line06*		pInstance = new CNPC_Line06(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line06"));
		Safe_Release(pInstance);
	}
