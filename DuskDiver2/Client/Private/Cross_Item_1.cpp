...
CCross_Item_1::CCross_Item_1(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{
}

CCross_Item_1::CCross_Item_1(const CCross_Item_1 & rhs)
	: CUI(rhs)
{
}

HRESULT CCross_Item_1::Initialize_Prototype()
{
...
HRESULT CCross_Item_1::Initialize(void * pArg)
{
...
void CCross_Item_1::Tick(_float fTimeDelta)
{
	...
	if (CK_DOWN(DIK_UP) && !UM->Get_ShopState())
	{
		switch (UM->Get_BattleItemNum(1))
		{
		case 0:
...
void CCross_Item_1::LateTick(_float fTimeDelta)
{
...
HRESULT CCross_Item_1::Render()
{
	...
	_uint i = UM->Get_BattleItemNum(1);
...
HRESULT CCross_Item_1::Ready_Components()
{
...
void CCross_Item_1::Render_Debug()
{
...
CCross_Item_1 * CCross_Item_1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CCross_Item_1*		pInstance = new CCross_Item_1(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CCross_Item_1"));
...
CGameObject * CCross_Item_1::Clone(void * pArg)
{
	CCross_Item_1*		pInstance = new CCross_Item_1(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CCross_Item_1"));
		Safe_Release(pInstance);
	}
