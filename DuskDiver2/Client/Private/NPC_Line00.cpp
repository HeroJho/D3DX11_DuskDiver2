...
CNPC_Line00::CNPC_Line00(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line00::CNPC_Line00(const CNPC_Line00 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line00::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line00::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(42.2f, 2.05f, 103.f, 1.f));

	return S_OK;
}

void CNPC_Line00::Tick(_float fTimeDelta)
{
...
void CNPC_Line00::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line00::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line00 * CNPC_Line00::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line00*		pInstance = new CNPC_Line00(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line00"));
...
CGameObject * CNPC_Line00::Clone(void * pArg)
{
	CNPC_Line00*		pInstance = new CNPC_Line00(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line00"));
		Safe_Release(pInstance);
	}
