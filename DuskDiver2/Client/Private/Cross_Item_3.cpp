...
CCross_Item_3::CCross_Item_3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{
}

CCross_Item_3::CCross_Item_3(const CCross_Item_3 & rhs)
	: CUI(rhs)
{
}

HRESULT CCross_Item_3::Initialize_Prototype()
{
...
HRESULT CCross_Item_3::Initialize(void * pArg)
{
...
void CCross_Item_3::Tick(_float fTimeDelta)
{
	...
	if (CK_DOWN(DIK_DOWN) && !UM->Get_ShopState())
	{
		switch (UM->Get_BattleItemNum(3))
		{
		case 0:
...
void CCross_Item_3::LateTick(_float fTimeDelta)
{
...
HRESULT CCross_Item_3::Ready_Components()
{
...
void CCross_Item_3::Render_Debug()
{
...
CCross_Item_3 * CCross_Item_3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CCross_Item_3*		pInstance = new CCross_Item_3(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CCross_Item_3"));
...
CGameObject * CCross_Item_3::Clone(void * pArg)
{
	CCross_Item_3*		pInstance = new CCross_Item_3(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CCross_Item_3"));
		Safe_Release(pInstance);
	}
