#include "stdafx.h"
#include "..\Public\Player01Pillar2.h"
#include "GameInstance.h"

CPlayer01Pillar2::CPlayer01Pillar2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CEffect(pDevice, pContext)
{
}

CPlayer01Pillar2::CPlayer01Pillar2(const CPlayer01Pillar2& rhs)
	: CEffect(rhs)
{
}

HRESULT CPlayer01Pillar2::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer01Pillar2::Initialize(void * pArg)
{
	m_pInfo = (*(PILLAR2INFO**)pArg);
...
void CPlayer01Pillar2::Tick(_float fTimeDelta)
{
...
void CPlayer01Pillar2::LateTick(_float fTimeDelta)
{
...
HRESULT CPlayer01Pillar2::Render()
{
...
HRESULT CPlayer01Pillar2::Ready_Components()
{
	/* For.Com_Transform */
...
CEffect * CPlayer01Pillar2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer01Pillar2*		pInstance = new CPlayer01Pillar2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CPlayer01Pillar2"));
...
CGameObject * CPlayer01Pillar2::Clone(void * pArg)
{
	CPlayer01Pillar2*		pInstance = new CPlayer01Pillar2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CPlayer01Pillar2"));
		Safe_Release(pInstance);
	}
