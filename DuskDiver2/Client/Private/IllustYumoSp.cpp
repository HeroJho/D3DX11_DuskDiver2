#include "stdafx.h"
#include "..\Public\IllustYumoSp.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CIllustYumoSp::CIllustYumoSp(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CIllustYumoSp::CIllustYumoSp(const CIllustYumoSp & rhs)
	: CUI(rhs)
{

}

HRESULT CIllustYumoSp::Initialize_Prototype()
{
...
HRESULT CIllustYumoSp::Initialize(void * pArg)
{
...
void CIllustYumoSp::Tick(_float fTimeDelta)
{
...
void CIllustYumoSp::LateTick(_float fTimeDelta)
{
...
void CIllustYumoSp::Render_Debug()
{
...
void CIllustYumoSp::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CIllustYumoSp::Ready_Components()
{
...
CIllustYumoSp * CIllustYumoSp::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CIllustYumoSp*		pInstance = new CIllustYumoSp(pDevice, pContext);
...
CGameObject * CIllustYumoSp::Clone(void * pArg)
{
	CIllustYumoSp*		pInstance = new CIllustYumoSp(*this);
