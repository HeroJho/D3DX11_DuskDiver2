...
CHolo_3::CHolo_3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_3::CHolo_3(const CHolo_3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_3::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_3::Initialize(void * pArg)
{
...
void CHolo_3::Tick(_float fTimeDelta)
{
	m_fTimeDelta += fTimeDelta;
	m_fTimeDeltaHoloAcc += fTimeDelta;
	if (1.f < m_fTimeDeltaHoloAcc)
	{
...
void CHolo_3::LateTick(_float fTimeDelta)
{
...
void CHolo_3::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_3::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Holo_1"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CHolo_3 * CHolo_3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_3*		pInstance = new CHolo_3(pDevice, pContext);
...
CGameObject * CHolo_3::Clone(void * pArg)
{
	CHolo_3*		pInstance = new CHolo_3(*this);
