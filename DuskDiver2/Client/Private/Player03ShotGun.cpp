#include "stdafx.h"
#include "..\Public\Player03ShotGun.h"
#include "GameInstance.h"

CPlayer03ShotGun::CPlayer03ShotGun(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CParts(pDevice, pContext)
{
}

CPlayer03ShotGun::CPlayer03ShotGun(const CPlayer03ShotGun & rhs)
	: CParts(rhs)
{
}

HRESULT CPlayer03ShotGun::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer03ShotGun::Initialize(void * pArg)
{
...
void CPlayer03ShotGun::Tick(_float fTimeDelta)
{
	
}

void CPlayer03ShotGun::LateTick(_float fTimeDelta)
{

}

HRESULT CPlayer03ShotGun::Render()
{
...
void CPlayer03ShotGun::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{


}

void CPlayer03ShotGun::Render_Debug()
{
...
HRESULT CPlayer03ShotGun::Ready_Components()
{
	/* For.Com_Shader */
...
CPlayer03ShotGun * CPlayer03ShotGun::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer03ShotGun*		pInstance = new CPlayer03ShotGun(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CPlayer03ShotGun"));
...
CGameObject * CPlayer03ShotGun::Clone(void * pArg)
{
	CPlayer03ShotGun*		pInstance = new CPlayer03ShotGun(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CPlayer03ShotGun"));
		Safe_Release(pInstance);
	}
