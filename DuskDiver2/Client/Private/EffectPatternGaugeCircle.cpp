#include "stdafx.h"
#include "..\Public\EffectPatternGaugeCircle.h"
#include "GameInstance.h"
#include "Time_Manager.h"
#include "Monster_Manager.h"

CEffectPatternGaugeCircle::CEffectPatternGaugeCircle(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CEffectPatternGaugeCircle::CEffectPatternGaugeCircle(const CEffectPatternGaugeCircle & rhs)
	: CGameObject(rhs)
{
}

HRESULT CEffectPatternGaugeCircle::Initialize_Prototype()
{

	return S_OK;
}

HRESULT CEffectPatternGaugeCircle::Initialize(void * pArg)
{
...
void CEffectPatternGaugeCircle::Tick(_float fTimeDelta)
{
	if (m_bRender)
	{
...
void CEffectPatternGaugeCircle::LateTick(_float fTimeDelta)
{
	if (m_bRender)
	{
...
HRESULT CEffectPatternGaugeCircle::Render()
{
...
void CEffectPatternGaugeCircle::Render_Debug()
{
...
HRESULT CEffectPatternGaugeCircle::Ready_Components()
{
	/* For.Com_Transform */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, L"PAtternGauge_Circular3", TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CEffectPatternGaugeCircle::SetUp_State(_fmatrix StateMatrix)
{
...
void CEffectPatternGaugeCircle::Reset_State()
{
...
CEffectPatternGaugeCircle * CEffectPatternGaugeCircle::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CEffectPatternGaugeCircle*		pInstance = new CEffectPatternGaugeCircle(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CEffectPatternGaugeCircle"));
...
CGameObject * CEffectPatternGaugeCircle::Clone(void * pArg)
{
	CEffectPatternGaugeCircle*		pInstance = new CEffectPatternGaugeCircle(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CEffectPatternGaugeCircle"));
		Safe_Release(pInstance);
	}
...
void CEffectPatternGaugeCircle::Free()
{
	__super::Free();
