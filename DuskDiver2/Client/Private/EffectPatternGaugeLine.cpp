#include "stdafx.h"
#include "..\Public\EffectPatternGaugeLine.h"
#include "GameInstance.h"
#include "Time_Manager.h"
#include "Monster_Manager.h"

CEffectPatternGaugeLine::CEffectPatternGaugeLine(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CEffectPatternGaugeLine::CEffectPatternGaugeLine(const CEffectPatternGaugeLine & rhs)
	: CGameObject(rhs)
{
}

HRESULT CEffectPatternGaugeLine::Initialize_Prototype()
{

	return S_OK;
}

HRESULT CEffectPatternGaugeLine::Initialize(void * pArg)
{
...
void CEffectPatternGaugeLine::Tick(_float fTimeDelta)
{
	if (m_bRender)
	{
...
void CEffectPatternGaugeLine::LateTick(_float fTimeDelta)
{
	if (m_bRender)
	{
...
HRESULT CEffectPatternGaugeLine::Render()
{
...
void CEffectPatternGaugeLine::Render_Debug()
{
...
HRESULT CEffectPatternGaugeLine::Ready_Components()
{
	/* For.Com_Transform */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, L"PatternGaugeLine2", TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CEffectPatternGaugeLine::SetUp_State(_fmatrix StateMatrix)
{
...
void CEffectPatternGaugeLine::Reset_State()
{
...
CEffectPatternGaugeLine * CEffectPatternGaugeLine::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CEffectPatternGaugeLine*		pInstance = new CEffectPatternGaugeLine(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CEffectPatternGaugeLine"));
...
CGameObject * CEffectPatternGaugeLine::Clone(void * pArg)
{
	CEffectPatternGaugeLine*		pInstance = new CEffectPatternGaugeLine(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CEffectPatternGaugeLine"));
		Safe_Release(pInstance);
	}
...
void CEffectPatternGaugeLine::Free()
{
	__super::Free();
