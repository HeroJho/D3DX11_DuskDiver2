#include "stdafx.h"
#include "..\Public\NumResultCombo.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumResultCombo::CNumResultCombo(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumResultCombo::CNumResultCombo(const CNumResultCombo & rhs)
	: CUI(rhs)
{

}

HRESULT CNumResultCombo::Initialize_Prototype()
{
...
HRESULT CNumResultCombo::Initialize(void * pArg)
{
...
void CNumResultCombo::Tick(_float fTimeDelta)
{
...
void CNumResultCombo::LateTick(_float fTimeDelta)
{
...
HRESULT CNumResultCombo::Render()
{
...
void CNumResultCombo::Render_Debug()
{
...
void CNumResultCombo::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumResultCombo::Ready_Components()
{
...
CNumResultCombo * CNumResultCombo::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumResultCombo*		pInstance = new CNumResultCombo(pDevice, pContext);
...
CGameObject * CNumResultCombo::Clone(void * pArg)
{
	CNumResultCombo*		pInstance = new CNumResultCombo(*this);
