...
CNPC_Line03::CNPC_Line03(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line03::CNPC_Line03(const CNPC_Line03 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line03::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line03::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(29.05f, 2.f, -3.55f, 1.f));

	return S_OK;
}

void CNPC_Line03::Tick(_float fTimeDelta)
{
...
void CNPC_Line03::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line03::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line03 * CNPC_Line03::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line03*		pInstance = new CNPC_Line03(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line03"));
...
CGameObject * CNPC_Line03::Clone(void * pArg)
{
	CNPC_Line03*		pInstance = new CNPC_Line03(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line03"));
		Safe_Release(pInstance);
	}
