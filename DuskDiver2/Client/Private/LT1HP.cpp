#include "stdafx.h"
#include "..\Public\LT1HP.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CLT1HP::CLT1HP(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CLT1HP::CLT1HP(const CLT1HP & rhs)
	: CUI(rhs)
{

}

HRESULT CLT1HP::Initialize_Prototype()
{
...
HRESULT CLT1HP::Initialize(void * pArg)
{
...
void CLT1HP::Tick(_float fTimeDelta)
{
	if (UM->Get_BackNum() == 4)
	{
...
void CLT1HP::LateTick(_float fTimeDelta)
{
...
void CLT1HP::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CLT1HP::Ready_Components()
{
...
CLT1HP * CLT1HP::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CLT1HP*		pInstance = new CLT1HP(pDevice, pContext);
...
CGameObject * CLT1HP::Clone(void * pArg)
{
	CLT1HP*		pInstance = new CLT1HP(*this);
