...
CDGCuma_1::CDGCuma_1(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CCreture(pDevice, pContext)
{
}

CDGCuma_1::CDGCuma_1(const CDGCuma_1 & rhs)
	: CCreture(rhs)
{
}

HRESULT CDGCuma_1::Initialize_Prototype()
{

	return S_OK;
}

HRESULT CDGCuma_1::Initialize(void * pArg)
{
...
void CDGCuma_1::Tick(_float fTimeDelta)
{
...
void CDGCuma_1::LateTick(_float fTimeDelta)
{
...
void CDGCuma_1::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{
...
void CDGCuma_1::Set_Down()
{
	m_bDown = true;
}

HRESULT CDGCuma_1::Ready_Components()
{
...
CDGCuma_1 * CDGCuma_1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CDGCuma_1*		pInstance = new CDGCuma_1(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CDGCuma_1"));
...
CGameObject * CDGCuma_1::Clone(void * pArg)
{
	CDGCuma_1*		pInstance = new CDGCuma_1(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CDGCuma_1"));
		Safe_Release(pInstance);
	}
