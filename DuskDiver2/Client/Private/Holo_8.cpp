...
CHolo_8::CHolo_8(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_8::CHolo_8(const CHolo_8 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_8::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_8::Initialize(void * pArg)
{
...
void CHolo_8::Tick(_float fTimeDelta)
{
...
void CHolo_8::LateTick(_float fTimeDelta)
{
...
void CHolo_8::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_8::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Holo_6"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CHolo_8 * CHolo_8::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_8*		pInstance = new CHolo_8(pDevice, pContext);
...
CGameObject * CHolo_8::Clone(void * pArg)
{
	CHolo_8*		pInstance = new CHolo_8(*this);
