...
CNPC_Line07::CNPC_Line07(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line07::CNPC_Line07(const CNPC_Line07 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line07::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line07::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(-15.5f, 1.95f, 170.3f, 1.f));

	return S_OK;
}

void CNPC_Line07::Tick(_float fTimeDelta)
{
...
void CNPC_Line07::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line07::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line07 * CNPC_Line07::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line07*		pInstance = new CNPC_Line07(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line07"));
...
CGameObject * CNPC_Line07::Clone(void * pArg)
{
	CNPC_Line07*		pInstance = new CNPC_Line07(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line07"));
		Safe_Release(pInstance);
	}
