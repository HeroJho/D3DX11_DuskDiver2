...
CHolo_7::CHolo_7(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_7::CHolo_7(const CHolo_7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_7::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_7::Initialize(void * pArg)
{
...
void CHolo_7::Tick(_float fTimeDelta)
{
...
void CHolo_7::LateTick(_float fTimeDelta)
{
...
void CHolo_7::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_7::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Holo_5"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CHolo_7 * CHolo_7::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_7*		pInstance = new CHolo_7(pDevice, pContext);
...
CGameObject * CHolo_7::Clone(void * pArg)
{
	CHolo_7*		pInstance = new CHolo_7(*this);
