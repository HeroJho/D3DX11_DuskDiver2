#include "stdafx.h"
#include "..\Public\NumWeapon2.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumWeapon2::CNumWeapon2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumWeapon2::CNumWeapon2(const CNumWeapon2 & rhs)
	: CUI(rhs)
{
}

HRESULT CNumWeapon2::Initialize_Prototype()
{
...
HRESULT CNumWeapon2::Initialize(void * pArg)
{
...
void CNumWeapon2::Tick(_float fTimeDelta)
{
...
void CNumWeapon2::LateTick(_float fTimeDelta)
{
...
void CNumWeapon2::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumWeapon2::Ready_Components()
{
...
CNumWeapon2 * CNumWeapon2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumWeapon2*		pInstance = new CNumWeapon2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNumWeapon2"));
...
CGameObject * CNumWeapon2::Clone(void * pArg)
{
	CNumWeapon2*		pInstance = new CNumWeapon2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNumWeapon2"));
		Safe_Release(pInstance);
	}
