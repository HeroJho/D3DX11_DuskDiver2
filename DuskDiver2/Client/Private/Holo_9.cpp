...
CHolo_9::CHolo_9(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_9::CHolo_9(const CHolo_9 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_9::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_9::Initialize(void * pArg)
{
...
void CHolo_9::Tick(_float fTimeDelta)
{
...
void CHolo_9::LateTick(_float fTimeDelta)
{
...
void CHolo_9::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_9::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Holo_7"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CHolo_9 * CHolo_9::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_9*		pInstance = new CHolo_9(pDevice, pContext);
...
CGameObject * CHolo_9::Clone(void * pArg)
{
	CHolo_9*		pInstance = new CHolo_9(*this);
