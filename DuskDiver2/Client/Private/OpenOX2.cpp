...
COpenOX2::COpenOX2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

COpenOX2::COpenOX2(const COpenOX2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT COpenOX2::Initialize_Prototype()
{
	return S_OK;
}

HRESULT COpenOX2::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(136.8f, -1.9f, 138.1f, 1.f));

	return S_OK;
}

void COpenOX2::Tick(_float fTimeDelta)
{
...
void COpenOX2::LateTick(_float fTimeDelta)
{
...
void COpenOX2::Render_Debug()
{
}

HRESULT COpenOX2::Ready_Components()
{
	/* For.Com_Transform */
...
COpenOX2 * COpenOX2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	COpenOX2*		pInstance = new COpenOX2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : COpenOX2"));
...
CGameObject * COpenOX2::Clone(void * pArg)
{
	COpenOX2*		pInstance = new COpenOX2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : COpenOX2"));
		Safe_Release(pInstance);
	}
