#include "stdafx.h"
#include "..\Public\LT3HP.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CLT3HP::CLT3HP(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CLT3HP::CLT3HP(const CLT3HP & rhs)
	: CUI(rhs)
{

}

HRESULT CLT3HP::Initialize_Prototype()
{
...
HRESULT CLT3HP::Initialize(void * pArg)
{
...
void CLT3HP::Tick(_float fTimeDelta)
{
	if (UM->Get_BackNum() == 4)
	{
...
void CLT3HP::LateTick(_float fTimeDelta)
{
...
void CLT3HP::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CLT3HP::Ready_Components()
{
...
CLT3HP * CLT3HP::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CLT3HP*		pInstance = new CLT3HP(pDevice, pContext);
...
CGameObject * CLT3HP::Clone(void * pArg)
{
	CLT3HP*		pInstance = new CLT3HP(*this);
