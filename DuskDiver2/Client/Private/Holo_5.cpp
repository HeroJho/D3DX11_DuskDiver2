...
CHolo_5::CHolo_5(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_5::CHolo_5(const CHolo_5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_5::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_5::Initialize(void * pArg)
{
...
void CHolo_5::Tick(_float fTimeDelta)
{
...
void CHolo_5::LateTick(_float fTimeDelta)
{
...
void CHolo_5::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_5::Ready_Components()
{
	/* For.Com_Transform */
...
CHolo_5 * CHolo_5::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_5*		pInstance = new CHolo_5(pDevice, pContext);
...
CGameObject * CHolo_5::Clone(void * pArg)
{
	CHolo_5*		pInstance = new CHolo_5(*this);
