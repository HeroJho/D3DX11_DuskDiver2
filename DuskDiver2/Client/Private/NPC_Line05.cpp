...
CNPC_Line05::CNPC_Line05(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line05::CNPC_Line05(const CNPC_Line05 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line05::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line05::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(23.3f, 2.f, 5.f, 1.f));

	return S_OK;
}

void CNPC_Line05::Tick(_float fTimeDelta)
{
...
void CNPC_Line05::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line05::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line05 * CNPC_Line05::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line05*		pInstance = new CNPC_Line05(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line05"));
...
CGameObject * CNPC_Line05::Clone(void * pArg)
{
	CNPC_Line05*		pInstance = new CNPC_Line05(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line05"));
		Safe_Release(pInstance);
	}
