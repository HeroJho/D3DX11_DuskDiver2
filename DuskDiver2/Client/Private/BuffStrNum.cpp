#include "stdafx.h"
#include "..\Public\BuffStrNum.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CBuffStrNum::CBuffStrNum(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CBuffStrNum::CBuffStrNum(const CBuffStrNum & rhs)
	: CUI(rhs)
{

}

HRESULT CBuffStrNum::Initialize_Prototype()
{
...
HRESULT CBuffStrNum::Initialize(void * pArg)
{
...
void CBuffStrNum::Tick(_float fTimeDelta)
{
...
void CBuffStrNum::LateTick(_float fTimeDelta)
{
...
void CBuffStrNum::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CBuffStrNum::Ready_Components()
{
...
CBuffStrNum * CBuffStrNum::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CBuffStrNum*		pInstance = new CBuffStrNum(pDevice, pContext);
...
CGameObject * CBuffStrNum::Clone(void * pArg)
{
	CBuffStrNum*		pInstance = new CBuffStrNum(*this);
