...
CMagHolo::CMagHolo(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CMagHolo::CMagHolo(const CMagHolo & rhs)
	: CGameObject(rhs)
{
}

HRESULT CMagHolo::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CMagHolo::Initialize(void * pArg)
{
...
void CMagHolo::Tick(_float fTimeDelta)
{
...
void CMagHolo::LateTick(_float fTimeDelta)
{
...
void CMagHolo::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CMagHolo::Ready_Components()
{
	/* For.Com_Transform */
...
CMagHolo * CMagHolo::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CMagHolo*		pInstance = new CMagHolo(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CMagHolo"));
...
CGameObject * CMagHolo::Clone(void * pArg)
{
	CMagHolo*		pInstance = new CMagHolo(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CMagHolo"));
		Safe_Release(pInstance);
	}
