...
CMon_HP2_Bar::CMon_HP2_Bar(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CMon_HP2_Bar::CMon_HP2_Bar(const CMon_HP2_Bar & rhs)
	: CGameObject(rhs)
{
}

HRESULT CMon_HP2_Bar::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CMon_HP2_Bar::Initialize(void * pArg)
{
...
void CMon_HP2_Bar::Tick(_float fTimeDelta)
{
...
void CMon_HP2_Bar::LateTick(_float fTimeDelta)
{
...
void CMon_HP2_Bar::Render_Debug()
{
...
HRESULT CMon_HP2_Bar::Ready_Components()
{
	/* For.Com_Transform */
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Monster_HP2_Bar"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CMon_HP2_Bar::Billboard()
{
...
CMon_HP2_Bar * CMon_HP2_Bar::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CMon_HP2_Bar*		pInstance = new CMon_HP2_Bar(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CMon_HP2_Bar"));
...
CGameObject * CMon_HP2_Bar::Clone(void * pArg)
{
	CMon_HP2_Bar*		pInstance = new CMon_HP2_Bar(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CMon_HP2_Bar"));
		Safe_Release(pInstance);
	}
