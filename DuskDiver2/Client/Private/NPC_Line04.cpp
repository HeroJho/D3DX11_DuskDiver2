...
CNPC_Line04::CNPC_Line04(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line04::CNPC_Line04(const CNPC_Line04 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line04::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line04::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(39.8f, 1.9f, -6.1f, 1.f));

	return S_OK;
}

void CNPC_Line04::Tick(_float fTimeDelta)
{
...
void CNPC_Line04::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line04::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line04 * CNPC_Line04::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line04*		pInstance = new CNPC_Line04(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line04"));
...
CGameObject * CNPC_Line04::Clone(void * pArg)
{
	CNPC_Line04*		pInstance = new CNPC_Line04(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line04"));
		Safe_Release(pInstance);
	}
