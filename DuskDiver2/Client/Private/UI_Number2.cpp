#include "stdafx.h"
#include "..\Public\UI_Number2.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CUI_Number2::CUI_Number2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CUI_Number2::CUI_Number2(const CUI_Number2 & rhs)
	: CUI(rhs)
{

}

HRESULT CUI_Number2::Initialize_Prototype()
{
...
HRESULT CUI_Number2::Initialize(void * pArg)
{
...
void CUI_Number2::Tick(_float fTimeDelta)
{
	//Combo마다 사이즈 효과 주기
	if (UM->Get_Up())
	{
...
void CUI_Number2::LateTick(_float fTimeDelta)
{
...
void CUI_Number2::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CUI_Number2::Ready_Components()
{
...
CUI_Number2 * CUI_Number2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CUI_Number2*		pInstance = new CUI_Number2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CUI_Number2"));
...
CGameObject * CUI_Number2::Clone(void * pArg)
{
	CUI_Number2*		pInstance = new CUI_Number2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CUI_Number2"));
		Safe_Release(pInstance);
	}
