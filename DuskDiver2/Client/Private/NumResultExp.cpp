#include "stdafx.h"
#include "..\Public\NumResultExp.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumResultExp::CNumResultExp(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumResultExp::CNumResultExp(const CNumResultExp & rhs)
	: CUI(rhs)
{

}

HRESULT CNumResultExp::Initialize_Prototype()
{
...
HRESULT CNumResultExp::Initialize(void * pArg)
{
...
void CNumResultExp::Tick(_float fTimeDelta)
{
...
void CNumResultExp::LateTick(_float fTimeDelta)
{
...
void CNumResultExp::Render_Debug()
{
...
void CNumResultExp::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumResultExp::Ready_Components()
{
...
CNumResultExp * CNumResultExp::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumResultExp*		pInstance = new CNumResultExp(pDevice, pContext);
...
CGameObject * CNumResultExp::Clone(void * pArg)
{
	CNumResultExp*		pInstance = new CNumResultExp(*this);
