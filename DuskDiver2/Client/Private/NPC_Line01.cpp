...
CNPC_Line01::CNPC_Line01(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CNPC_Line01::CNPC_Line01(const CNPC_Line01 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CNPC_Line01::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CNPC_Line01::Initialize(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(32.9f, 2.f, 166.f, 1.f));

	return S_OK;
}

void CNPC_Line01::Tick(_float fTimeDelta)
{
...
void CNPC_Line01::LateTick(_float fTimeDelta)
{
...
HRESULT CNPC_Line01::Ready_Components()
{
	/* For.Com_Transform */
...
CNPC_Line01 * CNPC_Line01::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNPC_Line01*		pInstance = new CNPC_Line01(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CNPC_Line01"));
...
CGameObject * CNPC_Line01::Clone(void * pArg)
{
	CNPC_Line01*		pInstance = new CNPC_Line01(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CNPC_Line01"));
		Safe_Release(pInstance);
	}
