#include "stdafx.h"
#include "..\Public\IllustYumoLv.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CIllustYumoLv::CIllustYumoLv(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CIllustYumoLv::CIllustYumoLv(const CIllustYumoLv & rhs)
	: CUI(rhs)
{

}

HRESULT CIllustYumoLv::Initialize_Prototype()
{
...
HRESULT CIllustYumoLv::Initialize(void * pArg)
{
...
void CIllustYumoLv::Tick(_float fTimeDelta)
{
...
void CIllustYumoLv::LateTick(_float fTimeDelta)
{
...
void CIllustYumoLv::Render_Debug()
{
...
void CIllustYumoLv::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CIllustYumoLv::Ready_Components()
{
...
CIllustYumoLv * CIllustYumoLv::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CIllustYumoLv*		pInstance = new CIllustYumoLv(pDevice, pContext);
...
CGameObject * CIllustYumoLv::Clone(void * pArg)
{
	CIllustYumoLv*		pInstance = new CIllustYumoLv(*this);
