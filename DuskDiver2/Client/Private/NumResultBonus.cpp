#include "stdafx.h"
#include "..\Public\NumResultBonus.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumResultBonus::CNumResultBonus(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumResultBonus::CNumResultBonus(const CNumResultBonus & rhs)
	: CUI(rhs)
{

}

HRESULT CNumResultBonus::Initialize_Prototype()
{
...
HRESULT CNumResultBonus::Initialize(void * pArg)
{
...
void CNumResultBonus::Tick(_float fTimeDelta)
{
...
void CNumResultBonus::LateTick(_float fTimeDelta)
{
...
HRESULT CNumResultBonus::Render()
{
...
void CNumResultBonus::Render_Debug()
{
...
void CNumResultBonus::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumResultBonus::Ready_Components()
{
...
CNumResultBonus * CNumResultBonus::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumResultBonus*		pInstance = new CNumResultBonus(pDevice, pContext);
...
CGameObject * CNumResultBonus::Clone(void * pArg)
{
	CNumResultBonus*		pInstance = new CNumResultBonus(*this);
