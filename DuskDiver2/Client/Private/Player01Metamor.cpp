#include "stdafx.h"
#include "..\Public\Player01Metamor.h"
#include "GameInstance.h"

CPlayer01Metamor::CPlayer01Metamor(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CEffect(pDevice, pContext)
{
}

CPlayer01Metamor::CPlayer01Metamor(const CPlayer01Metamor& rhs)
	: CEffect(rhs)
{
}

HRESULT CPlayer01Metamor::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer01Metamor::Initialize(void * pArg)
{
	m_pInfo = (*(METAMORINFO**)pArg);
...
void CPlayer01Metamor::Tick(_float fTimeDelta)
{
...
void CPlayer01Metamor::LateTick(_float fTimeDelta)
{
...
HRESULT CPlayer01Metamor::Render()
{
...
HRESULT CPlayer01Metamor::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Effect_Metamorphosis"), TEXT("Effect_Metamorphosis"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

CEffect * CPlayer01Metamor::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer01Metamor*		pInstance = new CPlayer01Metamor(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CPlayer01Metamor"));
...
CGameObject * CPlayer01Metamor::Clone(void * pArg)
{
	CPlayer01Metamor*		pInstance = new CPlayer01Metamor(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : CPlayer01Metamor"));
		Safe_Release(pInstance);
	}
