...
CHolo_5_Blue::CHolo_5_Blue(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CHolo_5_Blue::CHolo_5_Blue(const CHolo_5_Blue & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHolo_5_Blue::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHolo_5_Blue::Initialize(void * pArg)
{
...
void CHolo_5_Blue::Tick(_float fTimeDelta)
{
...
void CHolo_5_Blue::LateTick(_float fTimeDelta)
{
...
void CHolo_5_Blue::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{

}


HRESULT CHolo_5_Blue::Ready_Components()
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Holo_3"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
CHolo_5_Blue * CHolo_5_Blue::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CHolo_5_Blue*		pInstance = new CHolo_5_Blue(pDevice, pContext);
...
CGameObject * CHolo_5_Blue::Clone(void * pArg)
{
	CHolo_5_Blue*		pInstance = new CHolo_5_Blue(*this);
...
void CHolo_5_Blue::Render_Debug()
{
