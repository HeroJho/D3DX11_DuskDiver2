...
COpenOX3::COpenOX3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

COpenOX3::COpenOX3(const COpenOX3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT COpenOX3::Initialize_Prototype()
{
	return S_OK;
}

HRESULT COpenOX3::Initialize(void * pArg)
{
...
void COpenOX3::Tick(_float fTimeDelta)
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(89.8f, -5.8f, 147.f, 1.f));
	...
	m_pTransformCom->Rotation(XMVectorSet( 0,1.f,0,0), -31.3f);
}

void COpenOX3::LateTick(_float fTimeDelta)
{
...
void COpenOX3::Render_Debug()
{
}

HRESULT COpenOX3::Ready_Components()
{
	/* For.Com_Transform */
...
COpenOX3 * COpenOX3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	COpenOX3*		pInstance = new COpenOX3(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : COpenOX3"));
...
CGameObject * COpenOX3::Clone(void * pArg)
{
	COpenOX3*		pInstance = new COpenOX3(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX(TEXT("Failed To Cloned : COpenOX3"));
		Safe_Release(pInstance);
	}
