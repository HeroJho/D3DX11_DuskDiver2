...
CPlayer04Hair::CPlayer04Hair(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CParts(pDevice, pContext)
{
}

CPlayer04Hair::CPlayer04Hair(const CPlayer04Hair & rhs)
	: CParts(rhs)
{
}

HRESULT CPlayer04Hair::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer04Hair::Initialize(void * pArg)
{
...
void CPlayer04Hair::Tick(_float fTimeDelta)
{

}

void CPlayer04Hair::LateTick(_float fTimeDelta)
{
...
void CPlayer04Hair::Render_Debug()
{
...
void CPlayer04Hair::OnCollision(CCollider::OTHERTOMECOLDESC Desc)
{


}

void CPlayer04Hair::Render_Vtx()
{
...
PxRigidDynamic * CPlayer04Hair::Find_Rigid(const char * pName, CHierarchyNode** Out_pHeadBone)
{
...
_float4x4 CPlayer04Hair::Get_ConbineMatrix()
{
	_float4x4 Worldmatrix;
...
HRESULT CPlayer04Hair::Ready_Components()
{
	/* For.Com_Shader */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, L"Player04Hair", TEXT("Player04Hair"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CPlayer04Hair::Ready_JointHair()
{
	...
	PxRigidDynamic* pRigid1 = Find_Rigid("Hair01_B", &m_pHeadBone);
	m_pHeadRigid = pRigid1;
	XMStoreFloat4x4(&m_HeadInitComM, m_pHeadBone->Get_CombinedTransformation());
	PxRigidDynamic* pRigid2 = Find_Rigid("Hair02_B");
	PxRigidDynamic* pRigid3 = Find_Rigid("Hair03_B");
	PxRigidDynamic* pRigid4 = Find_Rigid("Hair04_B");
	PxRigidDynamic* pRigid5 = Find_Rigid("Hair05_B");
	PxRigidDynamic* pRigid6 = Find_Rigid("Hair06_B");
...
CPlayer04Hair * CPlayer04Hair::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer04Hair*		pInstance = new CPlayer04Hair(pDevice, pContext);
...
CGameObject * CPlayer04Hair::Clone(void * pArg)
{
	CPlayer04Hair*		pInstance = new CPlayer04Hair(*this);
...
void CPlayer04Hair::Render_HairCol()
{
