#include "stdafx.h"
#include "..\Public\NumBuy.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumBuy::CNumBuy(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumBuy::CNumBuy(const CNumBuy & rhs)
	: CUI(rhs)
{

}

HRESULT CNumBuy::Initialize_Prototype()
{
...
HRESULT CNumBuy::Initialize(void * pArg)
{
...
void CNumBuy::Tick(_float fTimeDelta)
{
...
void CNumBuy::LateTick(_float fTimeDelta)
{
...
void CNumBuy::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumBuy::Ready_Components()
{
...
CNumBuy * CNumBuy::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumBuy*		pInstance = new CNumBuy(pDevice, pContext);
...
CGameObject * CNumBuy::Clone(void * pArg)
{
	CNumBuy*		pInstance = new CNumBuy(*this);
