#include "stdafx.h"
#include "..\Public\IllustDDHp.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CIllustDDHp::CIllustDDHp(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CIllustDDHp::CIllustDDHp(const CIllustDDHp & rhs)
	: CUI(rhs)
{

}

HRESULT CIllustDDHp::Initialize_Prototype()
{
...
HRESULT CIllustDDHp::Initialize(void * pArg)
{
...
void CIllustDDHp::Tick(_float fTimeDelta)
{
...
void CIllustDDHp::LateTick(_float fTimeDelta)
{
...
void CIllustDDHp::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CIllustDDHp::Ready_Components()
{
...
CIllustDDHp * CIllustDDHp::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CIllustDDHp*		pInstance = new CIllustDDHp(pDevice, pContext);
...
CGameObject * CIllustDDHp::Clone(void * pArg)
{
	CIllustDDHp*		pInstance = new CIllustDDHp(*this);
