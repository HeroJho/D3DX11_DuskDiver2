#include "stdafx.h"
#include "..\Public\NumResult.h"
#include "GameInstance.h"
#include "UI_Manager.h"


CNumResult::CNumResult(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI(pDevice, pContext)
{

}

CNumResult::CNumResult(const CNumResult & rhs)
	: CUI(rhs)
{

}

HRESULT CNumResult::Initialize_Prototype()
{
...
HRESULT CNumResult::Initialize(void * pArg)
{
...
void CNumResult::Tick(_float fTimeDelta)
{
...
void CNumResult::LateTick(_float fTimeDelta)
{
...
void CNumResult::Set_Number(_uint iNum)
{
	m_iNumber = iNum;
...
HRESULT CNumResult::Ready_Components()
{
...
CNumResult * CNumResult::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNumResult*		pInstance = new CNumResult(pDevice, pContext);
...
CGameObject * CNumResult::Clone(void * pArg)
{
	CNumResult*		pInstance = new CNumResult(*this);
