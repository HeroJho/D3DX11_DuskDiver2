...
class CBear2 : public CCreture
{
private:
	CBear2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBear2(const CBear2& rhs);
	virtual ~CBear2() = default;
...
public:
	static CBear2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
