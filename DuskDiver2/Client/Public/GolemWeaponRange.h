...
class CGolemWeaponRange : public CGameObject
{
public:
...
private:
	CGolemWeaponRange(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CGolemWeaponRange(const CGolemWeaponRange& rhs);
	virtual ~CGolemWeaponRange() = default;
...
public:
	static CGolemWeaponRange* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
