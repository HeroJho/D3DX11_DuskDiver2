...
class CPlayer04HairBattle : public CParts
{
private:
	CPlayer04HairBattle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer04HairBattle(const CPlayer04HairBattle& rhs);
	virtual ~CPlayer04HairBattle() = default;
...
public:
	static CPlayer04HairBattle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
