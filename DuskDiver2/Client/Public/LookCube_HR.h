...
class CLookCube_HR final : public CGameObject
{
public:
...
private:
	CLookCube_HR(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CLookCube_HR(const CLookCube_HR& rhs);
	virtual ~CLookCube_HR() = default;
...
public:
	static CLookCube_HR* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
