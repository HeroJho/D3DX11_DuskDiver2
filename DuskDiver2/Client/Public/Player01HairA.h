...
class CPlayer01HairA : public CParts
{
private:
	CPlayer01HairA(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer01HairA(const CPlayer01HairA& rhs);
	virtual ~CPlayer01HairA() = default;
...
public:
	static CPlayer01HairA* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
