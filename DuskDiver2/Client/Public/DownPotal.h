...
class CDownPotal final : public CCreture
{
private:
	CDownPotal(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDownPotal(const CDownPotal& rhs);
	virtual ~CDownPotal() = default;
...
public:
	static CDownPotal* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
