...
class CBeastMap : public CEffect
{

private:
	CBeastMap(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBeastMap(const CBeastMap& rhs);
	virtual ~CBeastMap() = default;
...
public:
	static CBeastMap* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
