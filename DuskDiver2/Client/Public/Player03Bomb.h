...
class CPlayer03Bomb final : public CCreture
{
public:
...
private:
	CPlayer03Bomb(ID3D11Device * pDevice, ID3D11DeviceContext * pContext);
	CPlayer03Bomb(const CPlayer03Bomb& rhs);
	virtual ~CPlayer03Bomb() = default;
...
private:
	class CPointTrailObj* m_pPointTrail = nullptr;
	CShader*				m_pShaderCom = nullptr;
	CModel* m_pModelCom = nullptr;
	CTransform* m_pTransformCom2 = nullptr;
	BOMBINFO* m_pInfo = nullptr;
