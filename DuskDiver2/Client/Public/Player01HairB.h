...
class CPlayer01HairB : public CParts
{
private:
	CPlayer01HairB(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer01HairB(const CPlayer01HairB& rhs);
	virtual ~CPlayer01HairB() = default;
...
public:
	static CPlayer01HairB* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
