...
class CUpPotal final : public CCreture
{
private:
	CUpPotal(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUpPotal(const CUpPotal& rhs);
	virtual ~CUpPotal() = default;
...
public:
	static CUpPotal* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
