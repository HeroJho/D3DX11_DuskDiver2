...
class CEffectPatternGaugeCircle : public CGameObject
{
public:
...
private:
	CEffectPatternGaugeCircle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffectPatternGaugeCircle(const CEffectPatternGaugeCircle& rhs);
	virtual ~CEffectPatternGaugeCircle() = default;
...
public:
	static CEffectPatternGaugeCircle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
