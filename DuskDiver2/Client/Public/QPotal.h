...
class CQPotal final : public CCreture
{
private:
	CQPotal(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CQPotal(const CQPotal& rhs);
	virtual ~CQPotal() = default;
...
public:
	static CQPotal* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
