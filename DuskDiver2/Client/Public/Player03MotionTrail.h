...
class CPlayer03MotionTrail : public CGameObject
{
public:
	enum HEADTYPE {HEADA, HEADB, HEADEND};
public:
	typedef struct tagPlayer03MotionTrailInfo
	{
	...
	}PLAYER03MOTIONTRAILINFO;
private:
	CPlayer03MotionTrail(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer03MotionTrail(const CPlayer03MotionTrail& rhs);
	virtual ~CPlayer03MotionTrail() = default;
...
public:
	void Set_OnTrail(PLAYER03MOTIONTRAILINFO Info);
	...
	void Set_ShaderPass2(_uint iShaderPass2) { m_iShaderPass2 = iShaderPass2; }
private:
...
private:
	...
	_float4 m_vMotionTrailColor = { 0.5f,1.f,1.f,1.f };
...
public:
	static CPlayer03MotionTrail* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
