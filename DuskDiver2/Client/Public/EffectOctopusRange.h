...
class CEffectOctopusRange : public CGameObject
{
public:
...
private:
	CEffectOctopusRange(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffectOctopusRange(const CEffectOctopusRange& rhs);
	virtual ~CEffectOctopusRange() = default;
...
public:
	static CEffectOctopusRange* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
