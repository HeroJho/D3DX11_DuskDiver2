...
class CPlayer04Hair : public CParts
{
private:
	CPlayer04Hair(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPlayer04Hair(const CPlayer04Hair& rhs);
	virtual ~CPlayer04Hair() = default;
...
public:
	static CPlayer04Hair* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
