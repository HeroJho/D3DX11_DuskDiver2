...
class CEffectPatternGauge : public CGameObject
{
public:
...
private:
	CEffectPatternGauge(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffectPatternGauge(const CEffectPatternGauge& rhs);
	virtual ~CEffectPatternGauge() = default;
...
public:
	static CEffectPatternGauge* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
