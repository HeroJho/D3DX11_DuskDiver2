...
class CParticleInstanceTool final : public CBase
{
public:
...
public:
	CParticleInstanceTool(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CParticleInstanceTool() = default;
...
private:
	...
	_float3 m_vDirAngle = { 0.f,0.f,0.f };
	_float3 m_vRangeAngle1 = { 0.f,0.f,0.f };
	_float3 m_vRangeAngle2 = { 0.f,0.f,0.f };
	...
	_float2 m_vReleaseSpeed = { 0.f,0.f };
